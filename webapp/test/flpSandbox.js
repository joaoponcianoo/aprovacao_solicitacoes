		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ação Urgente",
									"targetURL": "#jgpdesafio5paprovacaosolicitacoes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jgpdesafio5paprovacaosolicitacoes-display": {
								"semanticObject": "jgpdesafio5paprovacaosolicitacoes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jgp.desafio5p.aprovacaosolicitacoes",
									"url": sap.ui.require.toUrl("jgp/desafio5p/aprovacaosolicitacoes")
								}
							}
						}
					}
