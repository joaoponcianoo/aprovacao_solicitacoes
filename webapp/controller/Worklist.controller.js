sap.ui.define([
    ...
    return BaseController.extend("jgp.desafio5p.aprovacaosolicitacoes.controller.Worklist", {
            ...
            if (aItems.length > 0) {
                aItems.forEach(async function(aEntry, i, array) {
                    ...
                    try {
                        ...
                        model.setProperty(path+"/NovoValor", preco);               
                    } catch {
        ...
        ajaxRequest: function(idMaterial) {
            ...
            return new Promise((resolve, reject) => {
                ...
                $.ajax({
                    url: "https://cors-anywhere.herokuapp.com/https://services.odata.org/V3/Northwind/Northwind.svc/Products(" + idMaterial + ")",
                    method: "GET",
                    dataType: "json",
                    crossDomain: true,
